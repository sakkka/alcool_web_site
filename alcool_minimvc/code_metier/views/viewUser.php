  ...
  <div id="inscription">
		            ...
		            <div id="masque">
						<form id="forminscr" action="/alcool_minimvc/user/inscription" method="POST">
							...
							<p> <input placeholder="Année de naissance" id="annee" name="naissance" type="text"  maxlength="4" size='40'/> <span id='errorannee'></span></p> 
							<p> <input placeholder="Adresse" name="adresse" type="text" size="40" maxlength="40"/> </p>
							<p> <input placeholder="Code Postal" name="postal" type="text" maxlength="5" size='40'/> </p>
