...
?>
		...
		<form id="formmodif" action="/alcool_minimvc/user/modification" method="POST">
			...
			<p> <input value=<?php echo $donnees[0]['CodePostal']?> name="postal" type="text" maxlength="5" size='40'/> </p>
			<p> <input value=<?php echo $ville?> name="ville" type="text" size="40" maxlength="20"/> </p>
